document.addEventListener("DOMContentLoaded", () => {
  ...
  function criarCartao(tarefa) {
    ...
    cartao.classList.add("etiqueta");
    cartao.classList.add("cartao__prazo");
    ...
    if (tarefa.prioridade.includes("alta")) {
      cartao.classList.add("etiqueta--alta");
    } else if (tarefa.prioridade.includes("media")) {
      cartao.classList.add("etiqueta--media");
    } else if (tarefa.prioridade.includes("baixa")) {
      cartao.classList.add("etiqueta--baixa");
    }
